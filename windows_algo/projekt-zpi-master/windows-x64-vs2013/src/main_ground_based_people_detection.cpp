...
public:
	...
	Eigen::Vector3f text_coord;
	text_coord[0] = 0.1582452;
	text_coord[1] = 0.1596036;
	text_coord[2] = 0.15973964;

	PointT asd;
	asd.getVector3fMap() = text_coord;


	viewer->addText("Kliknij w 3 punkty na podlodze trzymajac wcisniety SHIFT", 300, 300, 20, 1, 1, 1);
	struct callback_args cb_args;
	PointCloudT::Ptr clicked_points_3d(new PointCloudT);
	cb_args.clicked_points_3d = clicked_points_3d;
	cb_args.viewerPtr = pcl::visualization::PCLVisualizer::Ptr(viewer);
